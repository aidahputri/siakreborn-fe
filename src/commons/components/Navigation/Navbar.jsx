...
const Navbar = ({ isAuth, logout, menus, toggleSidebar }) => {
  ...
  return (
    <nav className="sticky top-0 navbar justify-between w-full py-0 px-4 bg-primary text-primary-content z-20 shadow-xl">
      <Brand />
      {!isNotAuthPage.includes(pathname) && <ul className="menu menu-horizontal rounded-box p-2 hidden lg:flex">
        {menus.map((menu) => (
      ...
      {!isNotAuthPage.includes(pathname) && <label htmlFor="drawer-toggle" className="flex-none lg:hidden">
