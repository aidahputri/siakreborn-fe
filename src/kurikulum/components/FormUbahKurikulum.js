...
, 	programStudi
  ...
  const { control, handleSubmit 
   } = useForm({ defaultValues: kurikulumUbah })
			  ...
			  <Controller
		        ...
		        render={({ field, fieldState }) => (
				  <InputField
		            ...
		            defaultValue={kurikulumUbah.kode}	            fieldState={fieldState}
					{...field}
					isRequired={false}
		          />
		        )}
			  ...
			  <Controller
		        ...
		        render={({ field, fieldState }) => (
				  <InputField
		            ...
		            defaultValue={kurikulumUbah.noSK}	            fieldState={fieldState}
					{...field}
					isRequired={false}
		          />
		        )}
			  ...
			  <Controller
		        ...
		        render={({ field, fieldState }) => (
				  <InputField
		            ...
		            defaultValue={kurikulumUbah.status}	            fieldState={fieldState}
					{...field}
					isRequired={false}
		          />
		        )}
			  ...
			  <Controller
		        ...
		        render={({ field, fieldState }) => (
				  <InputField
		            ...
		            defaultValue={kurikulumUbah.profilLulusan}	            fieldState={fieldState}
					{...field}
					isRequired={false}
		          />
		        )}
