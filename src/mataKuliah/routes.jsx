...
{ 
	...
	element: <RequireAuth permissionNeeded="CreateMataKuliah" ><TambahMataKuliahPage/></RequireAuth>
}	
,
{ 
	path: "/matakuliah/ubah",
	element: <RequireAuth permissionNeeded="UpdateMataKuliah" ><UbahMataKuliahPage/></RequireAuth>
}	
,
{ 
	path: "/matakuliah",
	element: <RequireAuth permissionNeeded="ReadMataKuliah" ><DaftarMataKuliahPage/></RequireAuth>
}	
,
{ 
	path: "/matakuliah/:id",
	element: <RequireAuth permissionNeeded="ReadMataKuliah" ><DetailMataKuliahPage/></RequireAuth>
}	
